...
function Hero() {
  return (
    <section className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden bg-dark-bg text-center -z-10">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-20">
        <div className="max-w-4xl mx-auto flex flex-col items-center animate-reveal">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-8">
            ...
            <a href="tel:+919999999999" className="text-dark-text-muted text-sm font-medium hover:text-dark-text transition-colors">
              or call us directly →
            </a>
          </div>
          
          {/* Trust strip */}
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-dark-text-muted text-xs sm:text-sm font-medium">
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-1 text-dark-text-muted/50 animate-bounce">
