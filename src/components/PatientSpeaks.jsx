...
const TestimonialCard = React.memo(({ item, priority }) => (
  <a
    ...
    className="group relative flex flex-col transition-all duration-500 ease-out hover:-translate-y-2 cursor-pointer"
  >
    ...
    <div className="relative aspect-[3/4.5] rounded-[3rem] overflow-hidden bg-white border border-border/60 shadow-sm group-hover:shadow-2xl group-hover:border-primary/30 transition-all duration-500">
      ...
      <img
        src={item.thumbnail}
        alt={`${item.name} - Plexus Dental Hub`}
        width={800}
        height={1200}
      ...
      {/* Instagram badge */}
      <div className="absolute top-16 right-5 z-20 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
  ...
  return (
    <section id="patient-speaks" className="bg-white py-16 sm:py-20 overflow-hidden border-t border-border/50 relative">
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        ...
        {/* 3-col grid, 7 items — last item centred on its own row */}
        ...
        <div className="flex justify-center mt-12 md:mt-16">
          <a
            href="https://www.instagram.com/plexusdentalhub/"
            target="_blank"
            rel="noopener noreferrer"
            className="group relative flex items-center gap-10 py-4 px-10 bg-white border border-border rounded-[2rem] overflow-hidden transition-all duration-500 hover:border-primary/40 active:scale-95 shadow-sm hover:shadow-2xl hover:shadow-primary/5"
          >
            ...
            <div className="relative z-10 flex items-center gap-8">
              ...
              <div className="relative flex items-center justify-center w-10 h-10">
                ...
                <Instagram className="relative w-4 h-4 text-text group-hover:text-primary transition-colors duration-500" />
              </div>
            </div>
